...
* --------------------------
* Passes assert if contents of 'expected'
* is unsigned less than 'actual'.
AL     DATA WORKSP,ALP
ALM    TEXT 'Expected '
ALM1   BSS   >4
...
* --------------------------
* Passes assert if contents of 'expected'
* is unsigned greater than 'actual'.
AH     DATA WORKSP,AHP
AHM    TEXT 'Expected '
AHM1   BSS  >4
...
* ----------------------
ONPASS
* Skip past the assertion mesage
       MOV  R14,R0
FIND1  MOVB *R14+,R1
       JNE  FIND1
* Round R14 up to even number
